...
// Six lanes each way, per the client. That width relative to the towers
// beside it is a large part of why the real corridor reads as Dubai rather
// than as any downtown — the tarmac is enormous.
const LANES = 6;
